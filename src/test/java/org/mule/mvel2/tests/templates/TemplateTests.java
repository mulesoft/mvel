...
import static org.mule.mvel2.templates.TemplateCompiler.compileTemplate;
...
public class TemplateTests extends TestCase {
    ...
    public void testFileBasedEval() {
        assertEquals("Foo::Bar", TemplateRuntime.eval(new File("src/test/java/org/mule/mvel2/tests/templates/templateTest.mv"),
                base, new MapVariableResolverFactory(map), null));
    }

    public void testInclusionOfTemplateFile() {
        String s = "<<@include{'src/test/java/org/mule/mvel2/tests/templates/templateTest.mv'}>>";
        assertEquals("<<Foo::Bar>>", test(s));
    }

    public void testInclusionOfTemplateFile2() {
        String s = "<<@include{'src/test/java/org/mule/mvel2/tests/templates/templateError.mv'}>>";
        try {
            test(s);
        }
    ...
    public void testTemplateFile() {
        String s = (String) TemplateRuntime.eval(new File("src/test/java/org/mule/mvel2/tests/templates/templateIfTest.mv"),
                base, new MapVariableResolverFactory(map), null);
