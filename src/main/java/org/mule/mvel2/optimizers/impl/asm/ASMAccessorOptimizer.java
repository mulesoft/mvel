...
import static org.mule.mvel2.MVEL.isAdvancedDebugging;
import static org.mule.mvel2.asm.Opcodes.*;
import static org.mule.mvel2.asm.Type.getConstructorDescriptor;
import static org.mule.mvel2.asm.Type.getDescriptor;
import static org.mule.mvel2.asm.Type.getInternalName;
import static org.mule.mvel2.asm.Type.getMethodDescriptor;
import static org.mule.mvel2.asm.Type.getType;
import static org.mule.mvel2.ast.TypeDescriptor.getClassReference;
import static org.mule.mvel2.integration.GlobalListenerFactory.hasGetListeners;
...
import static org.mule.mvel2.util.ParseTools.isPrimitiveWrapper;
...
import static org.mule.mvel2.util.ReflectionUtil.toNonPrimitiveArray;
...
import org.mule.mvel2.asm.Label;
...
import org.mule.mvel2.util.JITClassLoader;
...
public class ASMAccessorOptimizer extends AbstractOptimizer implements AccessorOptimizer {
  ...
  static {
    ...
    if (defaultNameSapce == null) NAMESPACE = "org/mule/mvel2/";
  ...
  private void visitConstantClass(Class<?> clazz) {
    ...
    if (clazz.isPrimitive()) {
        ...
        mv.visitLdcInsn(org.mule.mvel2.asm.Type.getType(clazz));
    }
  }
