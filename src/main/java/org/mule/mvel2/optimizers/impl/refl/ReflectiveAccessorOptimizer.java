 ...
 */
package org.mule.mvel2.optimizers.impl.refl;
...
import static org.mule.mvel2.integration.GlobalListenerFactory.hasSetListeners;
import static org.mule.mvel2.integration.GlobalListenerFactory.notifyGetListeners;
import static org.mule.mvel2.integration.GlobalListenerFactory.notifySetListeners;
import static org.mule.mvel2.integration.PropertyHandlerFactory.getNullMethodHandler;
import static org.mule.mvel2.integration.PropertyHandlerFactory.getNullPropertyHandler;
import static org.mule.mvel2.integration.PropertyHandlerFactory.getPropertyHandler;
import static org.mule.mvel2.integration.PropertyHandlerFactory.hasNullMethodHandler;
import static org.mule.mvel2.integration.PropertyHandlerFactory.hasNullPropertyHandler;
import static org.mule.mvel2.integration.PropertyHandlerFactory.hasPropertyHandler;
import static org.mule.mvel2.util.CompilerTools.expectType;
import static org.mule.mvel2.util.ParseTools.EMPTY_OBJ_ARR;
import static org.mule.mvel2.util.ParseTools.balancedCapture;
import static org.mule.mvel2.util.ParseTools.balancedCaptureWithLineAccounting;
import static org.mule.mvel2.util.ParseTools.captureContructorAndResidual;
import static org.mule.mvel2.util.ParseTools.determineActualTargetMethod;
import static org.mule.mvel2.util.ParseTools.findClass;
import static org.mule.mvel2.util.ParseTools.getBaseComponentType;
import static org.mule.mvel2.util.ParseTools.getBestCandidate;
import static org.mule.mvel2.util.ParseTools.getBestConstructorCandidate;
import static org.mule.mvel2.util.ParseTools.getSubComponentType;
import static org.mule.mvel2.util.ParseTools.getWidenedTarget;
import static org.mule.mvel2.util.ParseTools.parseMethodOrConstructor;
import static org.mule.mvel2.util.ParseTools.parseParameterList;
...
import static org.mule.mvel2.util.Varargs.normalizeArgsForVarArgs;
import static org.mule.mvel2.util.Varargs.paramTypeVarArgsSafe;
import org.mule.mvel2.CompileException;
import org.mule.mvel2.MVEL;
import org.mule.mvel2.OptimizationFailure;
...
import org.mule.mvel2.compiler.PropertyVerifier;
...
import org.mule.mvel2.optimizers.impl.refl.collection.ArrayCreator;
import org.mule.mvel2.optimizers.impl.refl.collection.ExprValueAccessor;
import org.mule.mvel2.optimizers.impl.refl.collection.ListCreator;
import org.mule.mvel2.optimizers.impl.refl.collection.MapCreator;
import org.mule.mvel2.optimizers.impl.refl.nodes.ArrayAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.ArrayAccessorNest;
import org.mule.mvel2.optimizers.impl.refl.nodes.ArrayLength;
import org.mule.mvel2.optimizers.impl.refl.nodes.ConstructorAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.DynamicFieldAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.DynamicFunctionAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.FieldAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.FieldAccessorNH;
import org.mule.mvel2.optimizers.impl.refl.nodes.FunctionAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.GetterAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.GetterAccessorNH;
import org.mule.mvel2.optimizers.impl.refl.nodes.IndexedCharSeqAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.IndexedCharSeqAccessorNest;
import org.mule.mvel2.optimizers.impl.refl.nodes.IndexedVariableAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.ListAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.ListAccessorNest;
...
import org.mule.mvel2.optimizers.impl.refl.nodes.MethodAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.MethodAccessorNH;
import org.mule.mvel2.optimizers.impl.refl.nodes.Notify;
import org.mule.mvel2.optimizers.impl.refl.nodes.NullAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.NullSafe;
import org.mule.mvel2.optimizers.impl.refl.nodes.PropertyHandlerAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.SetterAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.StaticReferenceAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.StaticVarAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.StaticVarAccessorNH;
import org.mule.mvel2.optimizers.impl.refl.nodes.ThisValueAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.Union;
import org.mule.mvel2.optimizers.impl.refl.nodes.VariableAccessor;
import org.mule.mvel2.optimizers.impl.refl.nodes.WithAccessor;
...
public class ReflectiveAccessorOptimizer extends AbstractOptimizer implements AccessorOptimizer {
  ...
  public Accessor optimizeSetAccessor(ParserContext pCtx, char[] property, int start, int offset, Object ctx,
    ...
    try {
      ...
      if (collection) {
        ...
        scanCollectionAccessor(new PropertyAccessException("unterminated '['", expr, this.start), st);
        ...
        while (cursor < end) {
          ...
          if (cursor < end) {
            if (nullSafe) {
              ...
              int offset;
              if (length < cursor) {
                offset = end - cursor - os;
              } else {
                offset = length - cursor - os;
              }
              addAccessorNode(new NullSafe(expr, cursor + os, offset, pCtx));
              if (curr == null) break;
            }
  ...
  private Object getCollectionProperty(Object ctx, String prop) throws Exception {
    ...
    scanCollectionAccessor(new PropertyAccessException("unterminated '['", expr, this.start), start);
  ...
  private Object getCollectionPropertyAO(Object ctx, String prop) throws Exception {
    ...
    scanCollectionAccessor(new PropertyAccessException("unterminated '['", expr, this.start), _start);
