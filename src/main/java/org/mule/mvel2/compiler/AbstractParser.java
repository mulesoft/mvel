...
import org.mule.mvel2.util.FunctionParser;
import org.mule.mvel2.util.ProtoParser;
...
import static org.mule.mvel2.util.PropertyTools.isEmpty;
  ...
  protected void reduce() {
    ...
    try {
      switch (operator = (Integer) stk.pop()) {
        ...
        case CONVERTABLE_TO:
          stk.push(org.mule.mvel2.DataConversion.canConvert(stk.peek2().getClass(), (Class) stk.pop2()));
          break;
